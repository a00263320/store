...
<body>
        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <form class="d-flex" action="/guest-search" method="get">
    ...
    <div class="container">
        <div class="row py-5">
            <div class="col-6">
                <div>
                    <img src="{{ $guest['photo'] }}" style="width: auto; height: auto" alt="...">
                </div>
            </div>
            ...
            <div class="col-6">
                ...
                {{-- 價錢 --}}
                <div>
                    <h5>NT$ <span class="h3"> {{ $guest['price'] }} </span> </h5>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <span style="font-size: 115%">{{ $guest['describe'] }}</span>
                    </div>
                    <hr>
                    {{-- 品牌 --}}
                    <div class="col">
                    ...
                    <div class="col">
                        <span style="font-size: 115%">{{ $guest['company'] }}</span>
                    </div>
                    <hr>
                    {{-- 生產地 --}}
                    <div class="col">
                    ...
                    <div class="col">
                        <span style="font-size: 115%">{{ $guest['origin'] }}</span>
                    </div>
                    <hr>
                    {{-- 操作 --}}
                    <div class="col">
